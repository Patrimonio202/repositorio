<footer class="flex flex-col items-center bg-neutral-900 text-center text-white">
    <div class="container px-6 pt-6">
        ...
        <div class="mb-6 flex justify-center">
            <!-- boton de facebook-->
            <a href="https://www.facebook.com/casadelaculturaelsantuario?mibextid=ZbWKwL" type="button"
            ...
            <!-- boton de instagram -->
            <a href="https://instagram.com/culturaelsantuario?igshid=OGQ5ZDc2ODk2ZA==" type="button"
                class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                data-te-ripple-init data-te-ripple-color="light">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-full w-4" fill="currentColor"
                    viewBox="0 0 24 24">
            ...
            <!-- boton de youtube -->
            <a href="https://youtube.com/@casadelaculturaelsantuario4286?si=Rubpjeusn-lIglpD" type="button"
                class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                data-te-ripple-init data-te-ripple-color="light">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-full w-4" fill="currentColor"
    ...
    <div class="w-full p-4 text-center" style="background-color: rgba(0, 0, 0, 0.2)">
        ...
        <a class="text-white" href="https://wa.me/573127877450?text=Desarrollo%20pagina%20web">Un desarrollo de Ing.
            Leonardo Gallego</a>
    </div>
