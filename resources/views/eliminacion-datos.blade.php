    ...
    <div class="pt-4 bg-gray-100">
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-2xl mt-6 mb-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">
                    ...
                    <h1>URL Instrucciones de Eliminación de Datos</h1>
                    <p>En concordancia con las regulaciones de Facebook para Apps y sitios web, debemos brindarle a los usuarios las instrucciones para eliminar sus datos. Si quieres eliminar tu actividad relacionada a la secretaria de cultura, lo puedes hacer de la siguiente manera.</p>
                    <ol>
