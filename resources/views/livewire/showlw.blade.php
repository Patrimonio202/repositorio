                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="lg:p-4 md:p-5 lg:space-y-4  ">
                        ...
                        {{-- <object data="{{ Storage::url($post->image->urlarchivo) }}" type="application/pdf"
                         ...
                         <iframe class=" w-full" height="600px" src="{{ secure_asset('pdfjs/web/viewer.html')}}?file=http://patrimonioelsantuario.gov.co/storage/{{$post->image->urlarchivo}}" frameborder="0"></iframe> 
