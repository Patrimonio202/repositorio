<x-app-layout>
    ...
    <footer class="flex flex-col items-center bg-neutral-900 text-center text-white">
        <div class="container px-6 pt-6">
            ...
            <div class="grid grid-cols-2 gap-16 mb-16 text-center lg:grid-cols-6">
                <div class="flex items-center justify-center rounded-full ">
                  <img src="{{ Storage::url('Imagenes/Logo1.jpg') }}" alt="Todoist Logo" class="rounded-full object-cover h-32  w-32" />
                </div>
                <div class="flex items-center justify-center">
                  <img src="{{ Storage::url('Imagenes/Logo1.jpg') }}" alt="Slack Logo" class="rounded-full object-cover h-32  w-32" />
                </div>
                <div class="flex items-center justify-center">
                  <img src="{{ Storage::url('Imagenes/Logo1.jpg') }}" alt="Typeform Logo" class="rounded-full object-cover h-32  w-32" />
                </div>
                <div class="flex items-center justify-center">
                  <img src="{{ Storage::url('Imagenes/Logo1.jpg') }}" alt="Algolia Logo" class="rounded-full object-cover h-32  w-32" />
                </div>
                <div class="flex items-center justify-center">
                  <img src="{{ Storage::url('Imagenes/Logo1.jpg') }}" alt="Postcss Logo" class="rounded-full object-cover h-32  w-32" />
                </div>
                <div class="flex items-center justify-center">
                  <img src="{{ Storage::url('Imagenes/Logo1.jpg') }}" alt="Yahoo Logo" class="rounded-full object-cover h-32  w-32" />
                </div>
              </div>
        ...
        <div class="w-full p-4 text-center" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2023 Copyright:
            <a class="text-white" href="#">Desarrollado por el Ingeniero Leonardo Gallego</a>
        </div>
    </footer>
