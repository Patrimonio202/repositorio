    ...
    <div class="py-12">
        ...
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <div class="hidden lg:block lg:w-1/2 bg-cover" 
                style="background-image:url({{ Storage::url('Imagenes/Fondologin.png') }})">
            </div>
            ...
            <div class="w-full p-8 lg:w-1/2">
                ...
                <a href="{{route('auth.redirect')}}" class="flex items-center justify-center mt-4 text-gray-600 border rounded-lg">
                    <div class="px-4 py-2">
                        <svg width="20" height="20" fill="currentColor" class="mr-2 text-blue-600" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="mt-4 flex items-center justify-between">
                    ...
                    <a href="#" class="text-xs text-center text-gray-500 uppercase">o inicia sesion con tu
                        email</a>
                    <span class="border-b w-1/5 lg:w-1/4"></span>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <input
                            class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                            type="password" name="password" id="loggingPassword">
                    </div>
                ...
                <div class="flex items-center justify-between mt-4">
                    ...
                    <a href="{{ route('register') }}" class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">¿NO TIENES CUENTA? REGÍSTRATE</a>
