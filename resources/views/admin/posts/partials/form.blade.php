...
<div class="form-group">
    ...
    {!! Form::text('anocreacion', null, ['class'=>'form-control','placeholder'=>'Ingrese el año de creación yyyy-mm-dd']) !!}
...
<div class="row mb-3">
    <div class="col">
       <div class="image-wrapper">
        ...
        @else
            <img id="picture" src="https://cdn.pixabay.com/photo/2023/10/03/08/24/goose-8290811_1280.jpg" alt="">
        @endisset
       </div>
    </div>
    <div class="col">
